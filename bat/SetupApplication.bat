...
:: Android packaging
set AND_CERT_NAME="SpaceShoot"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SpaceShoot.p12
...
set IOS_PROVISION=cert\SpaceShoot.mobileprovision
...
set APP_ID=air.SpaceShoot

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SpaceShoot
